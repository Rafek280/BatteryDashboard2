...
public class StatistiksGaugeManager {
    ...
    /*public void LoadStatistiken() {
        ...
        gauges2.add(new GaugeBlueprint(GaugeMetric.DURCHSCHNITTSGESCHWINDIGKEIT, GaugeType.GRAPHICAL, 20, 72));
        gauges2.add(new GaugeBlueprint(GaugeMetric.DURCHSCHNITTSVERBRAUCH, GaugeType.BIG_NUMBER, 180, 72));
