...
public class Dashboard extends ConstraintLayout implements IOverlay {
    ...
    public Dashboard(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    private void initializeViews(Context context) {
        ...
        content = (ViewGroup) inflater.inflate(R.layout.dashboard_layout, this);
    }
    ...
    Button getProfileButton(){
        return content.findViewById(R.id.load_btn);
    }
}
